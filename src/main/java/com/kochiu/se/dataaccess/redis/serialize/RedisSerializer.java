package com.kochiu.se.dataaccess.redis.serialize;
...
import com.kochiu.se.dataaccess.redis.annotation.RedisJsonField;
...
public class RedisSerializer {
	...
	public static <T> List<T> deserializeArray(Class<T> type, byte[] bytes) {
		try {
			...
			throw new SystemException("DeserializeArray error");
		}
	}
