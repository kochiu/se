package com.kochiu.se.core.tbschedule.config;
...
public class ScheduleParameter {
	 ...
	 * 心跳频率(毫秒)
	 */
	private int heartBeatRate = 2000;

	/**
	 * 假定服务死亡间隔(毫秒)
	 */
	private int judgeDeadInterval = 10000;
	...
	public String toString() {
		return "ScheduleParameter [taskName=" + taskName + ", taskBeanName=" + taskBeanName + ", heartBeatRate=" + heartBeatRate + ", judgeDeadInterval="
				+ judgeDeadInterval + ", threadNumber=" + threadNumber + ", fetchDataNumber=" + fetchDataNumber + ", executeNumber=" + executeNumber
				+ ", sleepTimeNoData=" + sleepTimeNoData + ", sleepTimeInterval=" + sleepTimeInterval + ", startTime=" + startTime + ", endTime=" + endTime
				+ ", maxTaskItemsOfOneThreadGroup=" + maxTaskItemsOfOneThreadGroup + ", expireOwnSignInterval=" + expireOwnSignInterval + ", taskItemList="
				+ taskItemList + ", extraInfo=" + extraInfo + ", status=" + status + ", processType=" + processType + ", strategyName=" + strategyName
				+ ", strategyType=" + strategyType + ", numOfSingleServer=" + numOfSingleServer + ", assignNum=" + assignNum + ", ipList=" + ipList + "]";
	}
